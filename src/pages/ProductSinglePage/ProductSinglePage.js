              ...
              <div className='product-details font-manrope'>
                ...
                <div className='info flex align-center flex-wrap fs-14'>
                  <div className='rating'>
                    <span className='text-danger fw-5'>Rating:</span>
                    <span className='mx-1 me-3'>
                      {product?.rating}
                    </span>
                  </div>
                  <div className='vert-line'></div>
                  <div className='brand'>
                    <span className='text-danger fw-5'>Brand:</span>
                    <span className='mx-1 me-3'>{product?.brand}</span>
                  </div>
                  <div className='vert-line'></div>
                  <div className='brand'>
                    <span className='text-danger fw-5'>Category:</span>
